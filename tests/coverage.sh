...
# These are intentionally declared-but-not-enforced (kept for save-format stability); documented.
WHITELIST = {"allowed-enchants", "receive-chat"}
...
if unexpected:
    ...
    sys.exit(1)
print("OK: every flag is enforced except the documented declared-only pair.")
PY
