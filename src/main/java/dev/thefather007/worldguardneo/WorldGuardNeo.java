package dev.thefather007.worldguardneo;

import com.mojang.logging.LogUtils;
import dev.thefather007.worldguardneo.commands.WGCommands;
...
public final class WorldGuardNeo {
    ...
    private void onServerStarting(ServerStartingEvent event) {
        ...
        dev.thefather007.worldguardneo.integrations.BluemapIntegration.init();
        dev.thefather007.worldguardneo.integrations.SquaremapIntegration.init();
    }
